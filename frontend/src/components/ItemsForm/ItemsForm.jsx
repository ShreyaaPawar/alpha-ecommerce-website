...
const ItemsForm = () => {
    ...
    return (
        <div className='item-form-container' style={{height:'100vh'}}>
                        ...
                        <div className="card-body">
                            <form onSubmit={onSubmitHandler}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <textarea rows={5} type="text" name="description" id="description" className='form-control' placeholder='Write content here...' onChange={onChangeHandler} value={data.description}/>
                                </div>
